...
define('_AM_WGSITENOTICE_OC_ERR_FORBIDDEN', "Entschuldigung, aber der angeführte Server gestattet den Download der dort vorhandenen Versionen nicht");
define('_AM_WGSITENOTICE_OC_ERR_NO_VERSIONS', "Entschuldigung, aber auf dem angeführten Server sind keine Versionen für den Download verfügbar");
