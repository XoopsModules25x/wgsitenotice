...
\define('_AM_WGSITENOTICE_FORMSUREDEL', "Wollen Sie diesen Eintrag wirklich löschen: <b><span style='color : Red;'>%s </span></b>");
\define('_AM_WGSITENOTICE_FORMSURERENEW', "Wollen Sie diesen Eintrag wirklich aktualisieren: <b><span style='color : Red;'>%s </span></b>");
// Lists
...
\define('_AM_WGSITENOTICE_VERSION_CURRENT', 'Diese Version anzeigen');
