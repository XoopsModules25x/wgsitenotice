...
define('_MB_WGSITENOTICE_COOKIE_REG_DATA', "Link zum rechtlichen Hinweis betreffend 'Datenschutz'");
define('_MB_WGSITENOTICE_COOKIE_REG_BASE', "Link zu den Erläuterungen betreffend 'Cookies'");
define('_MB_WGSITENOTICE_COOKIE_REG_INFO', "Diese Webseite verwendet Cookies. Durch die Nutzung der Webseite stimmen Sie der Verwendung von Cookies zu ");
define('_MB_WGSITENOTICE_COOKIE_REG_INFO_DATA', "Datenschutz");
define('_MB_WGSITENOTICE_COOKIE_REG_INFO_COOKIE_REG', "Cookie-Erläuterungen");
define('_MB_WGSITENOTICE_COOKIE_REG_DISPLAY', "Anzeigeart");
define('_MB_WGSITENOTICE_COOKIE_REG_DISPLAY_BLOCK', "Anzeige in einem Block");
define('_MB_WGSITENOTICE_COOKIE_REG_DISPLAY_SMARTY', "Anzeige mit Smarty");
define('_MB_WGSITENOTICE_COOKIE_REG_OPT_STYLE', "Style-Optionen");
